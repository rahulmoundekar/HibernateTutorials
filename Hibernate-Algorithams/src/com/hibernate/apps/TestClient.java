...
public class TestClient {
	public static void main(String args[]) {
		...
		// eb.setEid(101); //If we remove this comment also it will accept
		// increment algorithm at won't take at the time 101 value
		eb.setFname("Rahul");
		eb.setLname("Moundekar");
		eb.setEmail("rahulmundekar44@gmail.com");
